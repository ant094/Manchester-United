...
// Blok Kode untuk meminta izin pada Browser
            ...
            if (('PushManager' in window)) {
                navigator.serviceWorker.getRegistration().then(function (registration) {
                    registration.pushManager.subscribe({
                        ...
                        applicationServerKey: urlBase64ToUint8Array("BOmQQ0sRwtRPau8fkFxV5Uh0Ydqhb62tRQZM5MywhfR9xHxB6dC5NkERb_WeCgs8MyyEjvrOzRlWTHxQQ4qAr10")
...
// Blok Kode untuk hasilkan Generate pushSubscription
